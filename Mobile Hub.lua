...
loadstring(game:HttpGet("https://raw.githubusercontent.com/LenivayZopaKotaWork/Pluty-Hub/refs/heads/main/qwerty.lua"))()
	...
	-- LocalScript, можно грузить через loadstring
	local Players = game:GetService("Players")
	...
	btn.Position = UDim2.new(0.5, 0, 0.5, 0) -- центр экрана
	btn.Text = "≡"
	btn.TextSize = 30
	...
	btn.MouseButton1Click:Connect(function()
	    pressKey(Enum.KeyCode.G) -- тут меняешь на LeftControl если надо
	end)
